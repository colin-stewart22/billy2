Rails.application.routes.draw do
  ...
  get "restaurants/:id/tables/:table_id/table_orders/:table_order_id/table_customers/:table_customer_id/confirmation", to: "table_orders#confirmation", as: "confirmation"
